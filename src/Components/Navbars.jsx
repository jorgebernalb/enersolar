...
const Navbars = () =>{
    ...
    return(
        ...
        <Navbar.Brand ><img className="Logo" 
        src="https://e7.pngegg.com/pngimages/154/837/png-clipart-computer-icons-solar-energy-solar-panels-solar-power-energy-logo-renewable-energy.png" alt="Logo"/>
        </Navbar.Brand>
